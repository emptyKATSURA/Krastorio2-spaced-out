...
data:extend({
  {
    type = "projectile",
    name = "kr-matter-turret-rocket-projectile",
    flags = { "not-on-map" },
    hidden = true,
    acceleration = 0.1,
    action = {
      ...
      action_delivery = {
        ...
        target_effects = {
          ...
          {
            type = "create-entity",
            entity_name = "kr-matter-explosion",
          },
          {
            type = "camera-effect",
            effect = "screen-burn",
          ...
          {
            type = "damage",
            damage = { amount = 3000, type = "kr-radioactive" },
          },
          {
...

          {
            ...
            action = {
              ...
              action_delivery = {
                type = "projectile",
                projectile = "kr-antimatter-bomb-wave-spawns-fire-smoke-explosion",
          ...
          },
          {
            ...
            action = {
              ...
              action_delivery = {
                type = "projectile",
                projectile = "kr-antimatter-bomb-wave-spawns-matter-shockwave-explosion",
                starting_speed = 0.5 * 0.8,
                starting_speed_deviation = 0.075,
              },
            },
          },
          {
            ...
            action = {
              ...
              action_delivery = {
                type = "projectile",
                projectile = "kr-antimatter-bomb-wave-spawns-matter-smoke",
