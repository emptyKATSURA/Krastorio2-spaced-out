data:extend({
  {
    type = "recipe",
    name = "kr-small-portable-generator-equipment",
    energy_required = 10,
    enabled = false,
    ingredients = {
    ...
    results = { { type = "item", name = "kr-small-portable-generator-equipment", amount = 1 } },
  },
  {
    type = "item",
    name = "kr-small-portable-generator-equipment",
    ...
    place_as_equipment_result = "kr-small-portable-generator-equipment",
    subgroup = "equipment",
