data:extend({
  {
    type = "recipe",
    name = "kr-big-battery-mk3-equipment",
    energy_required = 60,
    enabled = false,
    ingredients = {
      { type = "item", name = "kr-big-battery-mk2-equipment", amount = 2 },
      { type = "item", name = "kr-lithium-sulfur-battery", amount = 4 },
      { type = "item", name = "processing-unit", amount = 2 },
    },
    results = { { type = "item", name = "kr-big-battery-mk3-equipment", amount = 1 } },
  },
  {
    type = "item",
    name = "kr-big-battery-mk3-equipment",
    ...
    place_as_equipment_result = "kr-big-battery-mk3-equipment",
    subgroup = "equipment",
