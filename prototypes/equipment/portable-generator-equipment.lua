data:extend({
  {
    ...
    ingredients = {
      ...
      { type = "item", name = "kr-small-portable-generator-equipment", amount = 2 },
    },
    results = { { type = "item", name = "kr-portable-generator-equipment", amount = 1 } },
  },
  {
    type = "item",
    name = "kr-portable-generator-equipment",
    icons = {
      { icon = "__Krastorio2Assets__/icons/equipment/portable-generator-equipment.png" },
      { icon = "__Krastorio2Assets__/icons/equipment/tier-2.png" },
    },
    place_as_equipment_result = "kr-portable-generator-equipment",
    subgroup = "equipment",
