...
data_util.add_or_replace_ingredient("cargo-wagon", "steel-plate", { type = "item", name = "kr-steel-beam", amount = 10 })
...
data_util.add_or_replace_ingredient("underground-belt", "iron-plate", { type = "item", name = "kr-iron-beam", amount = 2 })
...
data.raw.recipe["scrap-recycling"].results = {
      ...
      {type = "item", name = "kr-electronic-components",amount = 1, probability = 0.04, show_details_in_recipe_tooltip = false},
