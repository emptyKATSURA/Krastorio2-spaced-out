    ...
    graphics_set = {
      ...
      animation = {
        north = {
          layers = {
            {
              priority = "high",
              filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-N.png",
              line_length = 1,
              width = 194,
              height = 242,
              frame_count = 1,
            ...
            {
              priority = "high",
              filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-N-output.png",
              line_length = 5,
              width = 72,
              height = 66,
              frame_count = 5,
        ...
        east = {
          layers = {
            {
              priority = "high",
              filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-E.png",
              line_length = 1,
              width = 194,
              height = 94,
              frame_count = 1,
            ...
            {
              priority = "high",
              filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-E-output.png",
              line_length = 5,
              width = 50,
              height = 56,
              frame_count = 5,
        ...
        south = {
          layers = {
            {
              priority = "high",
              filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-S.png",
              line_length = 1,
              width = 194,
              height = 240,
              frame_count = 1,
        ...
        west = {
          layers = {
            {
              priority = "high",
              filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-W.png",
              line_length = 1,
              width = 194,
              height = 94,
              frame_count = 1,
            ...
            {
              priority = "high",
              filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-W-output.png",
              line_length = 5,
              width = 50,
              height = 56,
              frame_count = 5,
      ...
      working_visualisations = {
        ...
        -- drill back animation
        {
          ...
          north_animation = {
            layers = {
              graphics.mk3_animation(),
              graphics.shadow_animation(),
            },
          },
          east_animation = {
            layers = {
              graphics.mk3_horizontal_animation(),
        ...
        -- front frame
        {
          ...
          east_animation = {
            priority = "high",
            filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-E-front.png",
            line_length = 1,
            width = 208,
            height = 186,
            frame_count = 1,
          ...
          south_animation = {
            layers = {
              {
                priority = "high",
                filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-S-output.png",
                line_length = 5,
                width = 82,
                height = 56,
                frame_count = 5,
              ...
              {
                priority = "high",
                filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-S-front.png",
                line_length = 1,
                width = 172,
                height = 42,
                frame_count = 1,
          ...
          west_animation = {
            priority = "high",
            filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-W-front.png",
            line_length = 1,
            width = 210,
            height = 190,
            frame_count = 1,
      ...
      animation = {
        north = {
          layers = {
            {
              priority = "high",
              filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-N-wet.png",
              line_length = 1,
              width = 194,
              height = 242,
              frame_count = 1,
        ...
        west = {
          layers = {
            {
              priority = "high",
              filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-W-wet.png",
              line_length = 1,
              width = 194,
              height = 94,
              frame_count = 1,
        ...
        south = {
          layers = {
            {
              priority = "high",
              filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-S-wet.png",
              line_length = 1,
              width = 194,
              height = 240,
              frame_count = 1,
        ...
        east = {
          layers = {
            {
              priority = "high",
              filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-E-wet.png",
              line_length = 1,
              width = 194,
              height = 94,
              frame_count = 1,
        ...
        -- fluid window background (bottom)
        {
          ...
          north_animation = {
            layers = {
              {
                priority = "high",
                filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-N-wet-window-background-front.png",
                line_length = 1,
                width = 132,
                height = 28,
                frame_count = 1,
          ...
          south_animation = {
            layers = {
              {
                priority = "high",
                filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-S-wet-window-background.png",
                line_length = 1,
                width = 132,
                height = 88,
                frame_count = 1,
        ...
        -- fluid window background (front)
        {
          ...
          north_animation = {
            layers = {
              {
                priority = "high",
                filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-N-wet-window-background.png",
                line_length = 1,
                width = 30,
                height = 20,
                frame_count = 1,
          ...
          west_animation = {
            layers = {
              {
                priority = "high",
                filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-W-wet-window-background-front.png",
                line_length = 1,
                width = 88,
                height = 86,
                frame_count = 1,
          ...
          east_animation = {
            layers = {
              {
                priority = "high",
                filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-E-wet-window-background-front.png",
                line_length = 1,
                width = 86,
                height = 86,
                frame_count = 1,
        ...
        -- fluid base (bottom)
        {
          ...
          north_animation = {
            layers = {
              {
                priority = "high",
                filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-N-wet-fluid-background-front.png",
                line_length = 1,
                width = 130,
                height = 36,
                frame_count = 1,
          ...
          south_animation = {
            layers = {
              {
                priority = "high",
                filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-S-wet-fluid-background.png",
                line_length = 1,
                width = 130,
                height = 96,
                frame_count = 1,
        ...
        -- fluid base (front)
        {
          ...
          north_animation = {
            layers = {
              {
                priority = "high",
                filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-N-wet-fluid-background.png",
                line_length = 1,
                width = 28,
                height = 22,
                frame_count = 1,
          ...
          west_animation = {
            layers = {
              {
                priority = "high",
                filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-W-wet-fluid-background-front.png",
                line_length = 1,
                width = 82,
                height = 88,
                frame_count = 1,
          ...
          east_animation = {
            layers = {
              {
                priority = "high",
                filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-E-wet-fluid-background-front.png",
                line_length = 1,
                width = 82,
                height = 88,
                frame_count = 1,
        ...
        -- fluid flow (bottom)
        {
          ...
          north_animation = {
            layers = {
              {
                priority = "high",
                filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-N-wet-fluid-flow-front.png",
                line_length = 1,
                width = 130,
                height = 28,
                frame_count = 1,
          ...
          south_animation = {
            layers = {
              {
                priority = "high",
                filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-S-wet-fluid-flow.png",
                line_length = 1,
                width = 130,
                height = 88,
                frame_count = 1,
        ...
        -- fluid flow (front)
        {
          ...
          north_animation = {
            layers = {
              {
                priority = "high",
                filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-N-wet-fluid-flow.png",
                line_length = 1,
                width = 26,
                height = 20,
                frame_count = 1,
          ...
          west_animation = {
            layers = {
              {
                priority = "high",
                filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-W-wet-fluid-flow-front.png",
                line_length = 1,
                width = 84,
                height = 86,
                frame_count = 1,
          ...
          east_animation = {
            layers = {
              {
                priority = "high",
                filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-E-wet-fluid-flow-front.png",
                line_length = 1,
                width = 82,
                height = 86,
                frame_count = 1,
        ...
        -- front frame (wet)
        {
          ...
          north_animation = {
            layers = {
              {
                priority = "high",
                filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-N-wet-front.png",
                line_length = 1,
                width = 162,
                height = 124,
                frame_count = 1,
          ...
          west_animation = {
            layers = {
              {
                priority = "high",
                filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-W-wet-front.png",
                line_length = 1,
                width = 210,
                height = 190,
                frame_count = 1,
          ...
          south_animation = {
            layers = {
              ...
              {
                priority = "high",
                filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-S-wet-front.png",
                line_length = 1,
                width = 192,
                height = 70,
                frame_count = 1,
          ...
          east_animation = {
            layers = {
              {
                priority = "high",
                filename = "__Krastorio2Assets__/buildings/electric-mining-drill-mk3/electric-mining-drill-E-wet-front.png",
                line_length = 1,
                width = 208,
                height = 186,
                frame_count = 1,
