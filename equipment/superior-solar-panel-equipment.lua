data:extend({
  {
    ...
    ingredients = {
      ...
      { type = "fluid", name = "kr-nitric-acid", amount = 25 },
      { type = "item", name = "processing-unit", amount = 1 },
    },
    results = { { type = "item", name = "kr-superior-solar-panel-equipment", amount = 1 } },
  },
  {
    type = "item",
    name = "kr-superior-solar-panel-equipment",
    ...
    place_as_equipment_result = "kr-superior-solar-panel-equipment",
    subgroup = "equipment",
